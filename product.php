...
<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitProductForm" action="php_action/product/createProduct.php" method="POST" enctype="multipart/form-data">
				...
				<div class="div-result">
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane active" id="photo">
							<form action="php_action/product/editProductImage.php" method="POST" id="updateProductImageForm" class="form-horizontal" enctype="multipart/form-data">
						...
						<div role="tabpanel" class="tab-pane" id="productInfo">
							<form class="form-horizontal" id="editProductForm" action="php_action/product/editProduct.php" method="POST">
								<br />
