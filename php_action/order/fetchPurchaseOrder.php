...
if (isset($_SESSION['userId'])) {
	...
	$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM purchase_order WHERE company_id = $companyId AND user_id = $userId";
} else {
	$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM purchase_order WHERE company_id = $companyId";
}
 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a href="purchaseOrders.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
