...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <?php } else if ($_GET['o'] == 'editOrd') { ?>
            <i class="glyphicon glyphicon-edit"></i> Edit Purchase Order
        <?php } ?>
    ...
    <div class="panel-body">
        ...
        <?php if ($_GET['o'] == 'add') {
            ...
            <form class="form-horizontal" method="POST" action="php_action/order/createOrder.php" id="createOrderForm">
                ...
                <!--/form-group-->
                <div class="form-group">
                    <label for="clientName" class="col-sm-2 control-label">Saler Name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Saler Name" autocomplete="off" />
                    </div>
                </div>
                <!--/form-group-->
                <div class="form-group">
                    <label for="clientContact" class="col-sm-2 control-label">Saler Contact</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group submitButtonFooter">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <input type="hidden" class="form-control" id="type" name="type" value="purchase" />
            ...
            <form class="form-horizontal" method="POST" action="php_action/order/editOrder.php" id="editOrderForm">
                ...
                <table class="table" id="productTable">
                    ...
                    <tbody>
                        <?php
                            ...
                            $orderItemSql = "SELECT order_item.order_item_id, order_item.order_id, order_item.product_id, order_item.quantity, order_item.rate, order_item.total FROM order_item WHERE order_item.order_id = {$orderId} AND type = 'purchase'";
                ...
                <div class="form-group editButtonFooter">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <input type="hidden" name="userId" id="userId" value="<?php echo $data[14]  ?>" />
                        <input type="hidden" name="type" id="type" value="purchase" />
                        <input type="hidden" class="form-control" id="gstn" name="gstn" value="<?php echo $data[5] ?>" />
