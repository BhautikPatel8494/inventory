...
if ($_POST) {
    ...
    $sql = "INSERT INTO suggestion (name, phone, email, subject, message) VALUES ('$name', '$phone', '$email', '$subject', '$message')";
                ...
                <div class="col-xs-12">
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="mainmenu">
                        <ul class="nav navbar-nav primary-menu">
                            ...
                            <li><a href="#contact-area" id="contact_area">Suggestion</a></li>
                            <li></li>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 text-center">
                        <div class="header-text">
                            <div class="wow fadeInUp upper latter-space" data-wow-delay="0.2s">Everything you need to simplify your business invoicing, and more.</div>
                            <h2 class="header-title wow fadeInUp upper" data-wow-delay="0.4s">Stokers<span class="dot"></span></h2>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <div class="page-title text-center">
                        ...
                        <p>Our Simple working process For Activate Membership Of Stokers </p>
                    </div>
                </div>
            </div>
        ...
        <div class="contact-area">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title">
                            <h3 class="bar-title">Suggestion Box</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
