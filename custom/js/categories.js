...
$(document).ready(function() {
  ...
  manageCategoriesTable = $("#manageCategoriesTable").DataTable({
    ajax: "php_action/categories/fetchCategories.php",
    order: []
  });

  $("#addCategoriesModalBtn")
    .unbind("click")
    .bind("click", function() {
...
function editCategories(categoriesId = null) {
  if (categoriesId) {
    ...
    $.ajax({
      url: "php_action/categories/fetchSelectedCategories.php",
      type: "post",
    ...
    success: function(response) {
      $("#removeCategoriesBtn")
        ...
        .bind("click", function() {
          ...
          $.ajax({
            url: "php_action/categories/removeCategories.php",
            type: "post",
            data: { categoriesId: categoriesId },
            dataType: "json",
            success: function(response) {
