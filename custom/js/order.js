...
function printOrder(orderId = null) {
  if (orderId) {
    $.ajax({
      url: "php_action/order/printOrder.php",
      type: "post",
...
function addRow() {
  ...
  $.ajax({
    url: "php_action/order/fetchProductData.php",
    type: "post",
    dataType: "json",
    success: function(response) {
...
function getProductData(row = null) {
  if (row) {
    ...
    if (productId == "") {
      ...
      $.ajax({
        url: "php_action/order/fetchSelectedProduct.php",
        type: "post",
        ...
        $("#updatePaymentOrderBtn")
          ...
          .bind("click", function() {
            ...
            if (payAmount && paymentType && paymentStatus) {
              ...
              $.ajax({
                url: "php_action/order/editPayment.php",
                type: "post",
                data: {
                  orderId: orderId,
                  payAmount: payAmount,
